...
echo "========================================"
echo "  REVERT ASSIGNMENTS AUTHORIZER"
echo "========================================"
echo ""
...
# Remove authorizer from assignments endpoints
echo "Removing authorizer from /assignments endpoints..."
remove_authorizer "/assignments" "GET"
remove_authorizer "/assignments" "POST"
remove_authorizer "/assignments" "DELETE"
echo ""
...
aws apigateway create-deployment \
    ...
    --region $REGION \
    --stage-name prod \
    --description "Remove Cognito authorizer from assignments endpoints" \
    >/dev/null
...
echo ""
echo "Authorizer still active on:"
