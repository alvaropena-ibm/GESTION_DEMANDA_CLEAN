...
class CognitoService:
    ...
    def authenticate(self, email, password, new_password=None):
        ...
        try:
            ...
            if 'ChallengeName' in response:
                ...
                if challenge_name == 'NEW_PASSWORD_REQUIRED':
                    ...
                    if new_password:
                        ...
                        print(f"DEBUG - User attributes (password change): {user_info}")
                        ...
                        print(f"DEBUG - Team extracted (password change): {team}")
            ...
            # Extraer team del usuario (el atributo se llama 'custom:Team')
            print(f"DEBUG - User attributes: {user_info}")
            team = user_info.get('custom:Team') or user_info.get('custom:equipo') or user_info.get('custom:team') or user_info.get('Team') or user_info.get('team')
            print(f"DEBUG - Team extracted: {team}")
            name = user_info.get('name') or user_info.get('given_name') or email.split('@')[0]
